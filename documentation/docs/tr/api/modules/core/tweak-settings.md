...
**Yanıt Modeli (get):** [`TweakSettingsResponse`](https://github.com/ARAS-Workspace/phantom-wg/blob/retro/phantom/modules/core/models/config_models.py#L22)

**Yanıt Modeli (update):** [`TweakModificationResult`](https://github.com/ARAS-Workspace/phantom-wg/blob/retro/phantom/modules/core/models/config_models.py#L36)

...
Usage:
    ./tools/dev.sh test-scenario-e2e
    ./tools/dev.sh test-scenario-e2e --no-cleanup
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Scenario E2E test runner")
    parser.add_argument(

...
# ──────────────────────────────────────────────────────────────────
# Chaos E2E Bootstrap — generates WireGuard keypair
#
# Produces a clean, isolated environment under e2e_tests/chaos/container-data/
# Independent from the main development secrets.
#
# Usage:
#   e2e_tests/chaos/helpers/bootstrap.sh          (from repo root)
# ──────────────────────────────────────────────────────────────────

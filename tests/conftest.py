...
Markers: docker (container tests), integration (requires .so).
"""
...
def pytest_addoption(parser):
    ...
    parser.addoption("--no-docker-cleanup", action="store_true", default=False,
                     help="Keep container after tests for debugging")

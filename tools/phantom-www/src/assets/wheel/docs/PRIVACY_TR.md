...
[phantom.tc](https://retro.phantom.tc) üzerinden erişildiğinde, bu araç **Cloudflare Pages** aracılığıyla sunulmaktadır. Bu nedenle standart web altyapısı geçerlidir:
